package com.zzz.weather.logic.model
...
class DailyResponse (val status: String, val result: Result) {
    ...
    class Daily(val temperature: List<Temperature>, val skycon: List<Skycon>, @SerializedName("life_index")val indexLife: LifeIndex)
